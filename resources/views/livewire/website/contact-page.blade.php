                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.1s">
                        <div class="contact-item">
                            <div class="pb-5">
                                <h4 class="text-primary">Our global Contact</h4>
                                <h1 class="display-4 mb-4">Get In Touch With Us</h1>
                                <p class="mb-0">ADIM’s mission is to provide clients, communities, capital markets and shareholders with sustainable investment solutions by committing smart people, independent financial thought and disciplined processes.</p>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                                <div class="bg-primary btn-lg-square rounded-circle p-4"><i class="fa fa-home text-white"></i></div>
                                <div class="ms-4">
                                    <h4>Addresses</h4>
                                    <p class="mb-0">Unit No. 2403, 24th Floor, Tamouh Tower, Al Reem Island, Abu Dhabi, United Arab Emirates</p>
                                </div>
                            </div>
                            <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div class="ms-4">
                                    <h4>Email</h4>
                                    <p class="mb-0">lucratif@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="rounded h-100">
                            ...
                            style="height: 500px; margin-bottom: -6px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3630.9232728535408!2d54.395024199999995!3d24.4881152!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5e67b5cc74be05%3A0xdf92995f815f96d8!2sTamouh%20Tower%20-%20Al%20Reem%20Island%20-%20Tamouh%20-%20Abu%20Dhabi!5e0!3m2!1sen!2sae!4v1732887365316!5m2!1sen!2sae" 
